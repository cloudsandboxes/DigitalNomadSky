...
#>
param(
    [string]$GithubRepoUrl = "https://github.com/cloudsandboxes/digitalnomadsky.git",
...
try {
    ...
    $cloneArgs = @("clone", $GithubRepoUrl, $repoPath)
    & "$gitExe" @cloneaRGS 2>&1 | ForEach-Object {Write-Host $_ -ForegroundColor Gray}
